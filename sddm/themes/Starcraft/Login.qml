    ...
    */
    ...
    PlasmaComponents.TextField {
        ...
        style: TextFieldStyle {
            textColor: "#b8c6e4"
            selectedTextColor: "#7f899d"        // The highlighted text color
            selectionColor: "#0e1618"          // The text highlight color
            placeholderTextColor:"#b8c6e4"    // When the text field is empty
    ...
    PlasmaComponents.Button {
        ...
        style: ButtonStyle {
            background: Rectangle {
                ...
                radius: 2
                gradient: Gradient {
                    GradientStop { position: 0 ; color: control.pressed ? "#091f36" : "#091f36" } //haut
                    GradientStop { position: 1 ; color: control.pressed ? "#091e33" : "#091e33" } //bas
                }
                //implicitWidth: 100
                implicitHeight: 25
            }
